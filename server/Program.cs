...
namespace Server
{
    ...
    /// Main program.
    /// </summary>
    /// <see cref="https://raw.githubusercontent.com/dib0/HL7Fuse/master/HL7Fuse/Program.cs"/>
        ...
        private static void Main(string[] args)
        {
            ...
            else
            {
                ...
                if (args == null || args.Length < 1)
                {
                    ...
                    Console.WriteLine("The open source game server for Age of Empires Online.\n\n");
                    Console.WriteLine("Age of Empires Online © Microsoft Corporation.\n\n");
                    Console.WriteLine("Firesinging was created under Microsoft's 'Game Content Usage Rules' using assets from Age of Empires Online.");
                    Console.WriteLine("It is not endorsed by or affiliated with Microsoft.\n\n");
            ...
            else
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        bootstrap = (IBootstrap)Activator.GetObject(typeof(IBootstrap), string.Format("ipc://SuperSocket.Bootstrap[{0}]/Bootstrap.rem", (object)Math.Abs(AppDomain.CurrentDomain.BaseDirectory.TrimEnd(new char[1]{Path.DirectorySeparatorChar}).GetHashCode())));
