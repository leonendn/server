...
namespace Game.Command
{
    ...
    public class BRequestAllianceContestsStatus : CommandBase<Session, Package>
    {
        ...
        public override void ExecuteCommand(Session s, Package p)
        {
            ...
            Package Package = new Package(p.HeaderXuid, p.HeaderField20, p.HeaderServiceId, p.HeaderField22, (byte) PacketTypes.BResponseAllianceContestsStatus, p.HeaderRequestId, Response);
