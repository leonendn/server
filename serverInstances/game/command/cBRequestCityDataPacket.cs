...
namespace Game.Command
{
    ...
    public class BRequestCityDataPacket : CommandBase<Session, Package>
    {
        ...
        private static void _SendResponseCityDataStart(Session s, Package p, PacketBRequestCityDataPacket r)
        {
            ...
            Package Package = new Package(p.HeaderXuid, p.HeaderField20, p.HeaderServiceId, p.HeaderField22, (byte) PacketTypes.BResponseCityDataStartPacket, p.HeaderRequestId, Response);
